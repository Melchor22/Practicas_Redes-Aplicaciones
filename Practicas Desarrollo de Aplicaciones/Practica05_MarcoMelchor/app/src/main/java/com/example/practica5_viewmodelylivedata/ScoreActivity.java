package com.example.practica5_viewmodelylivedata;

import androidx.appcompat.app.AppCompatActivity;

import android.os.Bundle;

import com.example.practica5_viewmodelylivedata.databinding.ActivityScoreBinding;


public class ScoreActivity extends AppCompatActivity {

    public static final String LOCAL_SCORE_KEY = "Puntaje Local";
    public static final String VISITOR_SCORE_KEY = "Puntaje Visitante";
